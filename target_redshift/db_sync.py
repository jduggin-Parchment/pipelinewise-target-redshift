...
def column_type(schema_property, with_length=True):
    ...
    # TIMESTAMP WITH TIME ZONE is the better column type
        ...
        # Number types for our purpose is always monetary.  Convert to numeric from double scale.
        column_type = 'numeric'
        varchar_length = 38
        scale = 2
    ...
    if with_length:
        ...
        elif (column_type == 'numeric' and scale > 0) :
            column_type = '{}({},{})'.format(column_type, varchar_length, scale)
